...
//     const url = query
//       ? `https://newsapi.org/v2/everything?q=${query}&apiKey=f554669a771249e5a666a56c3e80cc6f`
//       : `https://newsapi.org/v2/top-headlines?country=us&category=technology&apiKey=f554669a771249e5a666a56c3e80cc6f`;
...
//           .filter((article) => article.content !== "[Removed]")
...
//           className="flex w-full max-w-lg shadow-md rounded-full overflow-hidden"
//         >
//           <input
//             type="text"
//             value={query}
...
export default function News() {
  ...
  const [selectedCategory, setSelectedCategory] = useState("technology"); // Single category
  ...
  const fetchNews = async (query, category) => {
    ...
    if (query) {
      url = `https://newsapi.org/v2/everything?q=${encodeURIComponent(
        query
      )}&apiKey=f554669a771249e5a666a56c3e80cc6f`;
    } else if (category) {
      url = `https://newsapi.org/v2/top-headlines?country=us&category=${category}&apiKey=f554669a771249e5a666a56c3e80cc6f`;
    } else {
      // Default to technology if no category is selected
      url = `https://newsapi.org/v2/top-headlines?country=us&category=technology&apiKey=f554669a771249e5a666a56c3e80cc6f`;
    }
