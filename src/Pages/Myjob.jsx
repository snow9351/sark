      ...
      <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4">
        <div className="my-jobs-container">
          ...
          <div className="search-box text-center p-2">
            ...
            />
            <button
              className="bg-blue text-white shadow-md font-semibold px-6 py-2 rounded-sm mb-4 md:px-8"
              ...
              <table className="min-w-full bg-white border border-gray-200">
                <thead>
                  <tr>
                    ...
                    <th className="py-2 px-2 md:px-4 border-b text-center">Posted By</th>
                ...
                <tbody>
                  {currentJobs.map((job) => (
                    <tr key={job._id} className="border-t">
                      ...
                      <td className="py-2 px-2 md:px-4 border-b text-center">{job.postedBy}</td>
                      <td className="py-2 px-2 md:px-4 border-b text-center">
                        <button
          ...
          <div className="pagination mt-4 flex justify-center items-center">
            {Array.from({ length: Math.ceil(jobs.length / jobsPerPage) }, (_, index) => (
              <button
                ...
                className={`mx-1 px-3 py-2 border-2 shadow-md rounded ${
                  currentPage === index + 1 ? 'bg-blue text-white' : 'bg-white text-black hover:bg-gray-200'
                }`}
              >
                {index + 1}
              </button>
